...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_beginning p_beginning;
        ...
        public static SteamVR_Input_ActionSet_beginning beginning
        {
            get
            {
                return SteamVR_Actions.p_beginning.GetCopy<SteamVR_Input_ActionSet_beginning>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_beginning = ((SteamVR_Input_ActionSet_beginning)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_beginning>("/actions/beginning")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.beginning};
        }
    }
}
